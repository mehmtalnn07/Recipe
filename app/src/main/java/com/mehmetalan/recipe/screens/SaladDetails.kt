...
fun SaladDetails(
    ...
    val salad = SaladCategoryDataSource.saladList.find { it.saladId == saladId }
        ...
        Column (
            ...
            Box(
                ...
                Image(
                    ...
                    contentDescription = "${salad.saladName} Image",
